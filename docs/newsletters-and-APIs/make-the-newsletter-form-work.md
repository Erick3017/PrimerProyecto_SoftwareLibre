...
Bien, ahora en este episodio vamos a agregar una dirección de correo electrónico a una lista de Mailchimp y actualizaremos el formulario del boletín.

Empezamos, ubicándonos en el archivo `web.php` y editamos la ruta `newsletter`.
...
Y para finalizar, una imagen de lo realizado
