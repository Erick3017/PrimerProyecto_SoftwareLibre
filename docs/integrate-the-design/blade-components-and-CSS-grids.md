...
En este episodio, continuaremos con la conversión, mientras nos tomamos un descanso de Laravel para jugar con las cuadrículas CSS.

Para iniciar, nos vamos a ubicar el archivo `post.blade.php` y comentaremos todo menos el componente `main` y escribiremos lo siguiente:
